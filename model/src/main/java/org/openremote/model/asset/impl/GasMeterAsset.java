...
public class GasMeterAsset extends Asset<GasMeterAsset> {
    ...
    public static final AssetDescriptor<GasMeterAsset> DESCRIPTOR = new AssetDescriptor<>("circle", "000080", GasMeterAsset.class);
    ...
    public GasMeterAsset setDirection(Integer value) {
    ...
    public GasMeterAsset setMeterType(String value) {
