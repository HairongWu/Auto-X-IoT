...
@Entity
public class GasProducerAsset extends GasAsset<GasProducerAsset> {
    ...
    public static final AssetDescriptor<GasProducerAsset> DESCRIPTOR = new AssetDescriptor<>("flash", "EABB4D", GasProducerAsset.class);

    /**
     * For use by hydrators (i.e. JPA/Jackson)
     */
    protected GasProducerAsset() {
    }

    public GasProducerAsset(String name) {
        super(name);
    }
