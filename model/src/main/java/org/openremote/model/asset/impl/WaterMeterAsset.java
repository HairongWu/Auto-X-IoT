...
public class WaterMeterAsset extends Asset<WaterMeterAsset> {
    ...
    public static final AssetDescriptor<WaterMeterAsset> DESCRIPTOR = new AssetDescriptor<>("circle", "000080", WaterMeterAsset.class);
    ...
    public WaterMeterAsset setDirection(Integer value) {
    ...
    public WaterMeterAsset setMeterType(String value) {
