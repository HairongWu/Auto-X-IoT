...
@Entity
public class WaterProducerAsset extends WaterAsset<WaterProducerAsset> {
    ...
    public static final AssetDescriptor<WaterProducerAsset> DESCRIPTOR = new AssetDescriptor<>("flash", "EABB4D", WaterProducerAsset.class);

    /**
     * For use by hydrators (i.e. JPA/Jackson)
     */
    protected WaterProducerAsset() {
    }

    public WaterProducerAsset(String name) {
        super(name);
    }
